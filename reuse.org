...
(well, no, those things are just *correlated with* abstractions which will make you succeed...
well no, open source and widely used are directly causal...
let's just be vague about why.)
