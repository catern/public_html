#+title: No more DSLs: Write a distributed system as a single richly-typed directly-runnable program
...
Each team at $DAYJOB maintains libraries for their components.
...
There are distributed languages and [[file:list_singledist.html][other models]] which aim at the same goal,
...
* Implementation of component libraries
  ...
  :END:
Now we'll step through an example of how a component library is implemented.
