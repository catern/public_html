...
then instead of writing a thousand different programs and configuration files and DSLs,
...
and I show some example programs.
...
A program written in such a language is only one component in a larger distributed system.
...
A component might communicate with other components, form a quorom, replicate and persist state,
or anything else a component might do in a distributed system.
